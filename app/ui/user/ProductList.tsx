...
export default function ProductList({products}: Props) {
    if (products.length === 0) {
        return <div className="rounded-md bg-gray-50 p-6">
            <div className="flex">
                <div className="flex-shrink-0">
                    <XMarkIcon className=" rounded-full border border-gray-400 h-5 w-5 text-gray-500"
                               aria-hidden="true"/>
                </div>
                <div className="ml-3 flex-1 md:flex md:justify-between">
                    <p className="text-sm text-gray-700">No product found.</p>
                </div>
            </div>
        </div>
    }
